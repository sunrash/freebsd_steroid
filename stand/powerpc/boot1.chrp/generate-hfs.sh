...
# $FreeBSD: releng/12.0/stand/powerpc/boot1.chrp/generate-hfs.sh 305894 2016-09-16 22:51:37Z jhibbits $
...
echo '# $FreeBSD: releng/12.0/stand/powerpc/boot1.chrp/generate-hfs.sh 305894 2016-09-16 22:51:37Z jhibbits $' >> Makefile.hfs
...
echo '$FreeBSD: releng/12.0/stand/powerpc/boot1.chrp/generate-hfs.sh 305894 2016-09-16 22:51:37Z jhibbits $' >> $OUTPUT_FILE.bz2.uu
