/*	$FreeBSD: releng/12.0/sys/dev/usb/wlan/if_ural.c 330749 2018-03-10 23:16:24Z avos $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: releng/12.0/sys/dev/usb/wlan/if_ural.c 330749 2018-03-10 23:16:24Z avos $");
